...
public class LogInStepDefinitionsNew extends TestBaseNew {
	...
	public void i_see_my_account_page() throws Throwable {
		...
		System.out.println(
				(iMonAccountPage == true) ? "I am on the account page after success logIn" : "this is not account page");
	}
	...
	public void i_am_not_able_to_LogIn() throws Throwable {
		...
		System.out.println(
				(iGetFailureMsg == true) ? "I am not able to logIn" : "LogIn failed but no failure message");
	...
	public void i_see_error_message(String arg1) throws Throwable {
		boolean iGetFailureMsg = logInPage.failureLogInMessage.isDisplayed();
		System.out.println(
				(iGetFailureMsg == true) ? "I get logIn-Failure message" : "No failure message I can read");
